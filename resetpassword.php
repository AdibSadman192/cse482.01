...
<head>
    ...
    <title>Reset Password - Online.Service</title>
                    ...
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <form class="text-center" method="post">
                                ...
                                <div class="mb-3"></div>
                                <div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit">Send mail</button></div>
                                <p class="text-muted">Remember Password?<a href="login.php" style="border-color: var(--bs-blue);">Login</a>&nbsp;</p>
                            </form>
                        </div>
                    </div>
                </div>
