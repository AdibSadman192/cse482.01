...
<body>
   <!--navbar-->
    ...
    </section><div class="shopping-cart">
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="border-0 align-middle"><strong>৳1000.00</strong></td>
                ...
                <tr>
                  ...
                  <td class="align-middle"><strong>৳790.00</strong></td>
        ...
        <div class="col-lg-6">
          ...
          <div class="p-4">
            ...
            <ul class="list-unstyled mb-4">
              <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Order Subtotal </strong><strong>৳2,580.00</strong></li>
              
              <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tax</strong><strong>৳20.00</strong></li>
              <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Total</strong>
                <h5 class="font-weight-bold">৳2600.00</h5>
              </li>
            </ul><a href="#" class="btn btn-primary shadow rounded-pill py-2 btn-block">checkout</a>
          </div>
        </div>
      </div>
    ...
    <footer class="text-center py-4">
        <div class="container">
            <div class="row row-cols-1 row-cols-lg-3">
                <div class="col">
                    <p class="text-muted my-2">Copyright&nbsp;© 2022 Online.Service</p>
                </div>
                <div class="col">
