...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2022 at 09:42 AM
...
(2, 'Home Cleaning', '1-5', '1300', '7 Days service warranty\r\n\r\n', 'Only service charge', 'Service cost', 0);
...
--
ALTER TABLE `contacts`
  MODIFY `contact_id` tinyint(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `home_packages`
  MODIFY `hpackages_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
