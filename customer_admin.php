        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="dashboard.php"><span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                <li class="nav-item"><a class="nav-link" href="dashboard.php">Dashboard</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link active" href="customer_admin.php">Customer</a></li>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="delete_user.php?customer_id=<?php echo $row['customer_id']; ?>" class="btn btn-primary">Delete</a></td>
